...
<%@ page import="java.util.List, dto.DomainDto, form.DomainUpdateForm" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>ドメイン情報変更 - NS変更</title>
...
<body>
    ...
    <div class="content">
        ...
        <%
            ...
            DomainUpdateForm form = (DomainUpdateForm) request.getAttribute("form");
            String ns1 = (form != null && form.getNs1() != null) ? form.getNs1() : (domain != null ? domain.getNs1() : "");
            String ns2 = (form != null && form.getNs2() != null) ? form.getNs2() : (domain != null ? domain.getNs2() : "");
        ...
        <div style="background-color:#f5f5f5; padding:10px; border-radius:5px; margin-bottom:20px;">
            <strong>変更対象ドメイン：</strong><%= domain != null ? domain.getDomainName() : "" %>
        </div>

        <div style="background-color:#f5f5f5; padding:20px; border-radius:5px; margin-bottom:20px;">
            <form method="post" action="domainUpdateNs">
