...
<body>
    ...
    <div class="content">
        ...
        <form method="post" action="hostRegisterExecute">
            <input type="hidden" name="hostName" value="<%= form.getHostName() %>">
            <input type="hidden" name="ipv4"     value="<%= form.getIpv4() != null ? form.getIpv4() : "" %>">
            <input type="hidden" name="ipv6"     value="<%= form.getIpv6() != null ? form.getIpv6() : "" %>">
